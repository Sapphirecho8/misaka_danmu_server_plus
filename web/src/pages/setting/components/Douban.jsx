...
export const Douban = () => {
  ...
  const canEdit = isSuperAdmin || !!perms.editDouban
  ...
  return (
    <div className="my-6">
      <Card loading={loading} title="豆瓣 Cookie 配置" className={canEdit ? '' : 'opacity-60'}>
        <div className="mb-4">
        ...
        {!canEdit && (
          <div className="text-gray-500 text-sm">您没有权限编辑豆瓣设置。</div>
        )}
      </Card>
    </div>
  )
