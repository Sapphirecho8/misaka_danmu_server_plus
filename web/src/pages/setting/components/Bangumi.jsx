...
export const Bangumi = () => {
  ...
  const canEdit = isSuperAdmin || !!perms.editBangumi
  ...
  return (
    <div className="my-6">
      <Card loading={loading} title="Bangumi API 配置" className={canEdit ? '' : 'opacity-60'}>
        <div className="mb-4">
        ...
        >
          ...
          <Form.Item>
            <div className="flex justify-end">
              <Button type="primary" htmlType="submit" loading={isSaveLoading} disabled={!canEdit}>
                保存修改
              </Button>
            </div>
          </Form.Item>
      ...
      >
        {authInfo.isAuthenticated ? (
          <div className="flex items-center justify-between">
            ...
            <Button type="primary" danger onClick={handleLogout} disabled={!canEdit}>
              注销
            </Button>
          </div>
        ) : (
          <div className="text-center py-4">
            ...
            <Button type="primary" onClick={handleLogin} disabled={!canEdit}>
              通过 Bangumi 登录
            </Button>
          </div>
        )}
