...
export const TVDB = () => {
  ...
  const canEdit = isSuperAdmin || !!perms.editTvdb
  ...
  return (
    <div className="my-6">
      <Card loading={loading} title="TVDB API 配置" className={canEdit ? '' : 'opacity-60'}>
        <div className="mb-4">
        ...
        {!canEdit && (
          <div className="text-gray-500 text-sm">您没有权限编辑 TVDB 设置。</div>
        )}
      </Card>
    </div>
  )
